...
typedef union
{
    ...
    uint32_t ptr;    //!< Numeric value used internally by the driver.
 ...
 */
#define NRFX_USBD_TRANSFER_IN_WITH_FLAGS(name, tx_buff, tx_size, tx_flags) \
...
#define NRFX_USBD_TRANSFER_IN(name, tx_buff, tx_size) \
    NRFX_USBD_TRANSFER_IN_WITH_FLAGS(name, tx_buff, tx_size, 0)
...
#define NRFX_USBD_TRANSFER_IN_ZLP(name, tx_buff, tx_size) \
    NRFX_USBD_TRANSFER_IN_WITH_FLAGS(                     \
        name,                                             \
        tx_buff,                                          \
        tx_size,                                          \
